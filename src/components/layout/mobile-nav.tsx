...
export function MobileNav({ locale }: MobileNavProps) {
  ...
  return (
    <div className="lg:hidden">
      ...
      {isOpen && (
        <div
          className="fixed inset-0 z-[99999] top-0 left-0 flex h-full h-[100dvh] w-full w-screen flex-col bg-background text-foreground overscroll-contain overflow-hidden"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div className="flex h-20 shrink-0 items-center justify-between border-b border-line px-4 sm:px-6 bg-background/95 backdrop-blur-xl">
            ...
            <button
              type="button"
              onClick={closeDrawer}
              className="inline-flex h-11 w-11 min-h-[44px] min-w-[44px] cursor-pointer touch-manipulation select-none items-center justify-center rounded-xl border border-line bg-panel text-ink shadow-xs transition-all active:scale-95 active:bg-muted hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 flex flex-col gap-5 overscroll-contain">
                        ...
                        {category.links.map((link, idx) => {
                          ...
                          return (
                            <Link
                              ...
                              onClick={closeDrawer}
                              className="flex flex-col rounded-xl border border-line/50 bg-background/80 p-3 transition-colors hover:bg-muted/70 touch-manipulation"
                            >
