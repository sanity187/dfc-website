...
export function MobileNav({ locale }: MobileNavProps) {
  ...
  return (
    <div className="lg:hidden relative z-50">
      ...
      {/* Fullscreen Mobile Navigation Drawer via Portal */}
      {isOpen &&
        mounted &&
        typeof document !== "undefined" &&
        createPortal(
          <div
            className="fixed inset-0 z-[9999] flex flex-col bg-background text-foreground animate-in fade-in-20 duration-200"
            role="dialog"
            aria-modal="true"
