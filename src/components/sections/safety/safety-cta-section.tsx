...
interface SafetyCtaSectionProps {
  locale: Locale;
}

export function SafetyCtaSection({ locale }: SafetyCtaSectionProps) {
  const { cta } = safetyContent;

  return (
    <section aria-label="Book Your Safe Jump" className="my-8">
