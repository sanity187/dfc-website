...
interface TandemFaqSectionProps {
  locale: Locale;
}

export function TandemFaqSection({ locale }: TandemFaqSectionProps) {
  const { faq } = tandemContent;

  return (
    <section aria-label="Tandem Skydiving Frequently Asked Questions" className="flex flex-col gap-10">
      <SectionHeading
