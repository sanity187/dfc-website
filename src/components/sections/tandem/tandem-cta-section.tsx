...
interface TandemCtaSectionProps {
  locale: Locale;
}

export function TandemCtaSection({ locale }: TandemCtaSectionProps) {
  const { cta } = tandemContent;

  return (
    <section aria-label="Book Tandem Jump" className="my-8">
