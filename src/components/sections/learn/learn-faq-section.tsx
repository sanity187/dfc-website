...
interface LearnFaqSectionProps {
  locale: Locale;
}

export function LearnFaqSection({ locale }: LearnFaqSectionProps) {
  const { faq } = learnContent;

  return (
    <section aria-label="Solo Skydiving Frequently Asked Questions" className="flex flex-col gap-10">
      <SectionHeading
