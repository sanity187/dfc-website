...
export function ContactCtaSection({ locale }: ContactCtaSectionProps) {
  const { cta } = contactContent;

  return (
    <section aria-label="Book or Contact Operations" className="my-8">
      <div className="relative overflow-hidden rounded-3xl border border-secondary/40 bg-gradient-to-br from-panel via-secondary/5 to-panel p-8 sm:p-12 shadow-2xl text-center">
        ...
        <div className="max-w-2xl mx-auto flex flex-col items-center gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4 w-full">
            <Link
              href={`/${locale}/book`}
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-secondary px-8 py-4 text-xs font-black uppercase tracking-wider text-slate-950 transition-all hover:bg-secondary-hover shadow-lg hover:shadow-secondary/20 hover:-translate-y-0.5 w-full sm:w-auto font-bold"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-line bg-canvas px-8 py-4 text-xs font-black uppercase tracking-wider text-ink transition-all hover:border-secondary hover:text-secondary w-full sm:w-auto font-bold"
            >
